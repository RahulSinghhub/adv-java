...
public class Tester {
	...
	public static void main(String[] args) throws InterruptedException{
		...
		t3.setDaemon(true);//when using this line causes the program to get executed fully rather than before when it was not executing 
		...
		t3.interrupt();//this wont interrupt t3 as t3 is blocked on input which is from java.io which is unblockable
