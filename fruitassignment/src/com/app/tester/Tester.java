	...
	public static void main(String[] args) {
		...
		try(Scanner in = new Scanner(System.in))
		{
			...
			case 3:System.out.println("Add apple");
			      System.out.println("\nadd name,colour,weight");
			      Fruit f3=new Apple(in.next(),in.next(),in.nextDouble());
			...
			case 4:
				System.out.println("Display all ");
			       ...
			       break;
			case 5:System.out.println("Display name,col,wt and taste");
			       for(Fruit a:fruitbasket)
		    	   if(a!=null) {
			...
			break;
			case 6:System.out.println("mark all sour fruits as not fresh");
			       for(Fruit a:fruitbasket)
			    	   if(a!=null) {   
		    	   if(a.taste().contains("sour")) {
		    	   a.setTaste(false);
		    	   }
			    	   }
			       for(Fruit a:fruitbasket)
