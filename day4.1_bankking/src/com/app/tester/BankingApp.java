...
import static  com.app.utils.BankAccountUtils.*;
			...
			while (!exit) {
				...
				try {
					...
					case 2: // display all account details
						...
						for (BankAccount a : accounts)   // foreach always works on the copy   
							if (a != null)
								System.out.println(a);

						break;
					case 3:System.out.println("account summary is ");
					// search in the array of banking accounts and the display the summary
					//use a.
					BankAccount aa = accountsumm(sc.nextInt(),accounts);
					System.out.println(aa);
					       
					       break;
					       
					case 4:System.out.println("You have choosen for withdrawl");
					      aa = accountsumm(sc.nextInt(),accounts);
					      System.out.println("balance after withdrawl"+aa.withdraw(sc.nextDouble()));
